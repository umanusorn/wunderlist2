...
public class AsyncDetail extends AsyncTask<String, String, String> {
...
void onPostExecute ( String result ) {
	...
	delegate.processFinish ( result, "detail" );
...
String doInBackground ( String... params ) {
	uRL = activity.getApplicationContext ().getResources ().getString ( R.string.server_url ) +
	      activity.getApplication ().getResources ().getString ( R.string.get_detail );
	String outPut = "";
	//JSONObject jObject=new JSONObject();
		...
		try {
			...
			jParams.put("product_id", params[0]);
