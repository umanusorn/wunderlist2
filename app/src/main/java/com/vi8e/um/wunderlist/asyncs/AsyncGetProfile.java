...
public
AsyncGetProfile ( Activity activity ) {
...
void onPostExecute ( String result ) {
	...
	delegate.processFinish ( result, "getprofile" );
...
String doInBackground ( String... params ) {
	uRL = activity.getApplicationContext ().getResources ().getString ( R.string.server_url ) +
	      activity.getApplication ().getResources ().getString ( R.string.get_profile );
	String outPut = "";
	JSONObject jParams = new JSONObject ();
		try {
			//jParams.put("auth", Utils.auth);
