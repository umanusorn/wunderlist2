...
public class AsyncGCMIsExist extends AsyncTask<String, String, String> {
...
public
AsyncGCMIsExist ( Activity activity ) {
...
//		progressDialog.dismiss();
	delegate.processFinish ( result, "gcmexist" );
...
String doInBackground ( String... params ) {
	uRL = activity.getApplicationContext ().getResources ().getString ( R.string.server_url ) +
	      activity.getApplication ().getResources ().getString ( R.string.gcm_exist );
	String outPut="";
