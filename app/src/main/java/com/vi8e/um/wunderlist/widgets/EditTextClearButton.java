package com.vi8e.um.wunderlist.widgets;
...
public class EditTextClearButton extends android.widget.EditText{
    ...
    public interface BackPressedListener {
        void onImeBack ( EditTextClearButton editText );
    }
...
public
EditTextClearButton ( Context context ) {
	super ( context );
	init ();
}

public
EditTextClearButton ( Context context, AttributeSet attrs, int defStyle ) {
	super ( context, attrs, defStyle );
	init ();
}

public
EditTextClearButton ( Context context, AttributeSet attrs ) {
	super ( context, attrs );
	init ();
}
...
void init () {
	...
	this.setOnTouchListener ( new OnTouchListener () {
		...
		boolean onTouch ( View v, MotionEvent event ) {
			...
			EditTextClearButton et = EditTextClearButton.this;
			...
			if ( et.getCompoundDrawables ()[ 2 ] == null )
                ...
                if (event.getX() > et.getWidth() - et.getPaddingRight() - imgCloseButton.getIntrinsicWidth()) {
                    et.setText("");
                    EditTextClearButton.this.handleClearButton();
                }
                return false;
            }
        });
