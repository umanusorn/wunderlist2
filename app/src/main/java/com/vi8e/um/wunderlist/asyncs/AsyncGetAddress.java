...
public class AsyncGetAddress extends AsyncTask<String, String, String> {
...
public
AsyncGetAddress ( Activity activity ) {
...
void onPostExecute ( String result ) {
	...
	delegate.processFinish ( result, "getaddress" );
...
String doInBackground ( String... params ) {
	uRL = activity.getApplicationContext ().getResources ().getString ( R.string.server_url ) +
	      activity.getApplication ().getResources ().getString ( R.string.get_address );
	String outPut = "";
