...
public class AsyncGetShoppingListItems extends AsyncTask<String, String, String> {
...
public
AsyncGetShoppingListItems ( Activity activity ) {
...
void onPostExecute ( String result ) {
	...
	delegate.processFinish ( result, "getitems" );
...
String doInBackground ( String... params ) {
	uRL = activity.getApplicationContext ().getResources ().getString ( R.string.server_url ) +
	      activity.getApplication ().getResources ().getString ( R.string.get_shoppinglist_items );
	String outPut = "";
