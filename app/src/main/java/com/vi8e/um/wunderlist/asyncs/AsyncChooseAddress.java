...
public class AsyncChooseAddress extends AsyncTask<String, String, String> {
...
public
AsyncChooseAddress ( Activity activity ) {
...
void onPostExecute ( String result ) {
	...
	delegate.processFinish ( result, "chooseaddress" );
...
String doInBackground ( String... params ) {
	uRL = activity.getApplicationContext ().getResources ().getString ( R.string.server_url ) +
	      activity.getApplication ().getResources ().getString ( R.string.get_choose_address );
	String outPut = "";
		...
		try {
			...
			jParams.put("action", "get");
			//jObject.put("params", jParams);
			Log.i ( "input", "choose addr = " + jParams.toString () );
