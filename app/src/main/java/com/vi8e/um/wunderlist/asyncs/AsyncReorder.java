...
public class AsyncReorder extends AsyncTask<String, String, String> {
...
public
AsyncReorder ( Activity activity ) {
...
void onPostExecute ( String result ) {
	...
	delegate.processFinish ( result, "reorder" );
...
String doInBackground ( String... params ) {
	uRL = activity.getApplicationContext ().getResources ().getString ( R.string.server_url ) +
	      activity.getApplication ().getResources ().getString ( R.string.reorder );
	String outPut = "";
