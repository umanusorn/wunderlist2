...
public class AsyncRemoveCode extends AsyncTask<String, String, String> {
...
public
AsyncRemoveCode ( Activity activity ) {
...
void onPostExecute ( String result ) {
	...
	delegate.processFinish ( result, "removecode" );
...
String doInBackground ( String... params ) {
	uRL = activity.getApplicationContext ().getResources ().getString ( R.string.server_url ) +
	      activity.getApplication ().getResources ().getString ( R.string.remove_code );
	String outPut = "";
