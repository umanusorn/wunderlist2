...
public class AsyncChangePassword extends AsyncTask<String, String, String> {
...
public
AsyncChangePassword ( Activity activity ) {
...
void onPostExecute ( String result ) {
	...
	delegate.processFinish ( result, "change" );
...
String doInBackground ( String... params ) {
	uRL = activity.getApplicationContext ().getResources ().getString ( R.string.server_url ) +
	      activity.getApplication ().getResources ().getString ( R.string.change_password );
	String outPut = "";
		...
		try {
			...
			jParams.put("password", params[0]);
			jParams.put("new_password", params[1]);
			jParams.put("force", Integer.parseInt ( params[ 2 ] ));
