...
public class AsyncGetTopic extends AsyncTask<String, String, String> {
...
public
AsyncGetTopic ( Activity activity ) {
...
void onPostExecute ( String result ) {
	...
	delegate.processFinish ( result, "gettopic" );
...
String doInBackground ( String... params ) {
	uRL = activity.getApplicationContext ().getResources ().getString ( R.string.server_url ) +
	      activity.getApplication().getResources().getString(R.string.get_feedback_topic);
		String outPut="";
