 ...
 */
public
MultiDirectionSlidingDrawer ( Context context, AttributeSet attrs ) {
...
private
void animateClose ( int position ) {
	prepareTracking ( position );
	performFling ( position, mMaximumAcceleration, true );
}

private
void animateOpen ( int position ) {
	prepareTracking ( position );
	performFling ( position, - mMaximumAcceleration, true );
}

private
void performFling ( int position, float velocity, boolean always ) {
...
private
void prepareTracking ( int position ) {
	mTracking = true;
	...
	private void prepareContent()
	{
		...
		if ( content.isLayoutRequested() ) {
			...
			if ( mVertical ) {
				...
				content.measure( MeasureSpec.makeMeasureSpec( getRight () - getLeft (), MeasureSpec.EXACTLY ), MeasureSpec.makeMeasureSpec( height,
				                                                                                                                            MeasureSpec.EXACTLY ) );
