...
public class AsyncDeleteShoppingList extends AsyncTask<String, String, String> {
...
public
AsyncDeleteShoppingList ( Activity activity ) {
...
void onPostExecute ( String result ) {
	...
	delegate.processFinish ( result, "deleteshoppinglist" );
...
String doInBackground ( String... params ) {
	uRL = activity.getApplicationContext ().getResources ().getString ( R.string.server_url ) +
	      activity.getApplication ().getResources ().getString ( R.string.remove_shoppinglist );
	String outPut = "";
