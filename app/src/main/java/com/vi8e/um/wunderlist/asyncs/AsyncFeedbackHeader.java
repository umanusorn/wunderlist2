...
public class AsyncFeedbackHeader extends AsyncTask<String, String, String> {
...
public
AsyncFeedbackHeader ( Activity activity ) {
...
void onPostExecute ( String result ) {
	...
	delegate.processFinish ( result, "getheader" );
...
String doInBackground ( String... params ) {
	uRL = activity.getApplicationContext ().getResources ().getString ( R.string.server_url ) +
	      activity.getApplication ().getResources().getString(R.string.get_feedback_page);
		String outPut="";
