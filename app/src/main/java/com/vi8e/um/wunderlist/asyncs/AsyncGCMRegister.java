...
public class AsyncGCMRegister extends AsyncTask<String, String, String> {
...
public
AsyncGCMRegister ( Activity activity ) {
...
//		progressDialog.dismiss();
	delegate.processFinish ( result, "gcmreg" );
...
String doInBackground ( String... params ) {
	uRL = activity.getApplicationContext ().getResources ().getString ( R.string.server_url ) +
	      activity.getApplication ().getResources ().getString ( R.string.gcm_reg_url );
	String outPut="";
		...
		try {
			...
			jDevice.put("unique_id", params[0]);
			jDevice.put("type", "android");
			jParams.put("device", jDevice);
