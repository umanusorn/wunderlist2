...
public static boolean toggleImgCompleteData(View v, SubTaskModel subTaskModel, Context context) {
...
public static boolean toggleImgCompleteData(View v, SubTaskModel subTaskModel, Drawable normal, Drawable clicked) {
	ImageView imageView = (ImageView) v;
