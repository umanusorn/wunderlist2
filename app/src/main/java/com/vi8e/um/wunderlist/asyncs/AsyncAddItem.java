...
public class AsyncAddItem extends AsyncTask<String, String, String> {
...
public
AsyncAddItem ( Activity activity ) {
...
void onPostExecute ( String result ) {
	...
	delegate.processFinish ( result, "addcart" );
...
String doInBackground ( String... params ) {
	uRL = activity.getApplicationContext ().getResources ().getString ( R.string.server_url ) +
	      activity.getApplication ().getResources ().getString ( R.string.add_item );
	String outPut = "";
