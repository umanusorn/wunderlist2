...
public class AsyncGetTransStatus extends AsyncTask<String, String, String> {
...
public
AsyncGetTransStatus ( Activity activity ) {
...
void onPostExecute ( String result ) {
	...
	delegate.processFinish ( result, "transstatus" );
...
String doInBackground ( String... params ) {
	uRL = activity.getApplicationContext ().getResources ().getString ( R.string.server_url ) +
	      activity.getApplication ().getResources ().getString ( R.string.get_status );
	String outPut = "";
