...
public class AsyncPWP extends AsyncTask<String, String, String> {
...
void onPostExecute ( String result ) {
	...
	delegate.processFinish ( result, "pwp" );
...
String doInBackground ( String... params ) {
	uRL = activity.getApplicationContext ().getResources ().getString ( R.string.server_url ) +
	      activity.getApplication ().getResources ().getString ( R.string.get_PWP );
	String outPut = "";
