 ...
 */
public class BasedRecycleAdapter extends RecyclerView.Adapter<BasedRecycleAdapter.ViewHolder> {
 ...
 */
public BasedRecycleAdapter(ArrayList<SubTaskModel> dataSet, Context context) {
	mDataSet = dataSet;
	mContext = context;
}
