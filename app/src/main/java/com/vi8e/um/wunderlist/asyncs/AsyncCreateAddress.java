...
public class AsyncCreateAddress extends AsyncTask<String, String, String> {
...
public
AsyncCreateAddress ( Activity activity ) {
...
void onPostExecute ( String result ) {
	...
	delegate.processFinish ( result, "createaddress" );
...
String doInBackground ( String... params ) {
	uRL = activity.getApplicationContext ().getResources ().getString ( R.string.server_url ) +
	      activity.getApplication ().getResources ().getString ( R.string.create_address );
	String outPut = "";
