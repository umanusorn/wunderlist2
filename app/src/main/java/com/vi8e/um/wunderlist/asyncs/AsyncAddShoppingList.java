...
public class AsyncAddShoppingList extends AsyncTask<String, String, String> {
...
public
AsyncAddShoppingList ( Activity activity ) {
...
void onPostExecute ( String result ) {
	...
	delegate.processFinish ( result, "addshoppinglist" );
...
String doInBackground ( String... params ) {
	uRL = activity.getApplicationContext ().getResources ().getString ( R.string.server_url ) +
	      activity.getApplication ().getResources ().getString ( R.string.add_shoppinglist );
	String outPut = "";
