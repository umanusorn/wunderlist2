...
public class AsyncGetShoppingList extends AsyncTask<String, String, String> {
...
public
AsyncGetShoppingList ( Activity activity ) {
...
void onPostExecute ( String result ) {
	...
	delegate.processFinish ( result, "getshoppinglist" );
...
String doInBackground ( String... params ) {
	uRL = activity.getApplicationContext ().getResources ().getString ( R.string.server_url ) +
	      activity.getApplication ().getResources ().getString ( R.string.get_shoppinglist );
	String outPut = "";
