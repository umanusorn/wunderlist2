...
public class AsyncGetOrderDetail extends AsyncTask<String, String, String> {
...
public
AsyncGetOrderDetail ( Activity activity ) {
...
void onPostExecute ( String result ) {
	...
	delegate.processFinish ( result, "orderdetail" );
...
String doInBackground ( String... params ) {
	uRL = activity.getApplicationContext ().getResources ().getString ( R.string.server_url ) +
	      activity.getApplication ().getResources ().getString ( R.string.get_order_detail );
	String outPut = "";
